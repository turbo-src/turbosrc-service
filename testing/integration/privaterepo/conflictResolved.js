...
describe("Conflict", function () {
    ...
    it("Should return a PR in 'conflict'", async () => {
        ...
        assert.equal(voteRes, '201', 'unable to vote in mergeable')
        ...
        assert.deepEqual(
         ...
         { status: 200, state: "update", repo_id: repoID,  fork_branch: "pullRequest6", "mergeableCodeHost": true, "childDefaultHash": "b22871b5c66fed0b8969453151e93f40d014434c", "defaultHash": "4534afa8b4ce247d2f538f98651e34d0ceb223e9" },
          "Fail to find out status of pull request."
        );
    });
});