...
describe('Vote on conflict resovled pull request.', function () {
    ...
    before(async () => {
        ...
        //    /*repo: */ repoID,
        //    /*defaultHash:*/ "issue_6",
        //    /*childDefaultHash:*/ "issue_6",
	    /*m//ergeable:*/ true,
        //    /*contributor_id:*/ tsrctester1ID,
        //    /*side:*/ "yes",
	    /*t//oken:*/ testerTokenA
        //);
        //socket.emit('vote cast', contributor_name, repoID, "issue_6")
        //socket.disconnect()

    });
    describe.only('A single majority voter votes on a conflict resolved PR.', function () {
      it("Should close vote and then merge.", async () => {
        ...
        assert.equal(true, false, "fail assertion")
