...
(async () => {
  var status = await postGetPRforkStatus("vim", "vim","issue_9472", "matveyt")
  if (status === 'pull') {
    console.log(status)
    await postPullFork("vim", "vim","issue_9472", "matveyt")
  } else if (status === 'valid') {
    console.log('valid')
  } else if (status === 'notOnGithub') {
    console.log('notOnGithub')
  } else {
    status = await postGetPRforkStatus("vim", "vim","issue_9472", "matveyt")
    console.log(status)
  }
